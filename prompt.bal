...
You should strictly follow this Output Format. We aim for the question to be as comprehensive as possible. But never answer the question by yourself.if there is a code segment in the question or answer,when you generating the ouput,format those codes parts(change the font,key word color and more) use html tags to do that.If there any list in the question or answesrs render them as appopriate list using html tags.
